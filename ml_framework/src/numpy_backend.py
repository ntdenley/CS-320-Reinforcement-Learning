...
class NumpyBackend(BackendInterface):
    ...
    def rand(self, shape): return np.random.rand(shape, dtype=dtype)
    ...
    def subtract(self, inp1, inp2, out): return np.subtract(inp1, inp2, out)
    def multiply(self, inp1, inp2, out): return np.multiply(inp1, inp2, out)
    def divide(self, inp1, inp2, out): return np.divide(inp1, inp2, out)
